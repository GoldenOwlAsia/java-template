-- Insert Permissions
INSERT INTO GO_PERMISSION (id, name, description) VALUES
...
-- Insert Roles
INSERT INTO GO_ROLE (id, name) VALUES
    ('role-1', 'ADMIN'),
    ('role-2', 'USER');

-- Insert Role-Permission Mapping for ADMIN
INSERT INTO GO_ROLE_PERMISSIONS (role_id, permission_id) VALUES
    ('role-1', 'perm-1'),
    ('role-1', 'perm-2'),
    ('role-1', 'perm-3'),
    ('role-1', 'perm-4');
...
INSERT INTO GO_USER_ROLES (user_id, role_id) VALUES
